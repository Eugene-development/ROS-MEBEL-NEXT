        ...
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-7xl pt-10 pb-16 sm:pt-20 sm:pb-18">
            <div>
              ...
              <div>
                <h1 className="max-w-7xl text-5xl font-bold tracking-tight sm:text-center sm:text-7xl">
                    <span className="relative whitespace-nowrap text-blue-600">
								...
								<span className="relative">Мебель на заказ</span> <br />
							</span>
                ...
                <div className="mt-8 flex gap-x-4 sm:justify-center">
                  <Link
                    href="/catalog"
                    className="inline-block rounded-lg bg-gradient-to-tr from-blue-600 via-blue-700 to-blue-600 hover:bg-gradient-to-bl px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-blue-600 hover:bg-blue-700 hover:ring-blue-700"
                  >
                    Посмотреть каталог{' '}
