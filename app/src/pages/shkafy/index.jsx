    ...
    <div class="relative overflow-hidden bg-white py-16">
      <div class="relative px-6 lg:px-8">
        ...
        <div class="max-w-7xl prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
          ...
          <p>
            Не медлите и купите свой новый шкаф уже сегодня, чтобы повысить функциональность и стиль вашей комнаты. Вы не пожалеете о своей покупке!
          </p>
        </div>
      </div>
    </div>
